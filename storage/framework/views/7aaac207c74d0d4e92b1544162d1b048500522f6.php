...
<div id="app">
    <div class="sidebar">
        <div class="sidebar__profile">
            <img class="d-block mx-auto p-4" src="<?php echo e(asset('img/trabajoequipo.png')); ?>"/>
        ...
        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(\Illuminate\Support\Facades\Route::has($menu->ruta)): ?>
                <div class="sidebar__item">
                    <a class="sidebar__link waves-effect <?php echo e(active(route($menu->ruta))); ?>"
                       href="<?php echo e(route($menu->ruta)); ?>"><i
                            class="fa fa-<?php echo e($menu->icon); ?>"></i>&nbsp;<?php echo e($menu->titulo); ?></a>
                </div>
            <?php endif; ?>
    ...
    <main class="main">
        <nav class="topbar navbar navbar-light bg-white d-flex">
            ...
            <a class="navbar-brand" href="#"><?php echo e(env('APP_NAME','Polindustria Asistencias')); ?></a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu position-absolute dropdown-menu-right " style="z-index: 100">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('admin.close')); ?>">Cerrar Sesión</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<?php /**PATH /var/www/html/asistencia/resources/views/layouts/admin.blade.php ENDPATH**/ ?>